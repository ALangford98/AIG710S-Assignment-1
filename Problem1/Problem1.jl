...
using PlutoUI### A Pluto.jl notebook ###
# v0.14.5
...
# ╔═╡ 40489e09-503e-48ad-ad07-7e6ede454003
function pickup(Office, Action)
	if Action == co
		Office.ItemCount - 1
	end
end
...
# ╔═╡ 8747a66d-6a84-4d65-b168-ddb0022a8b45


# ╔═╡ bd7a37ad-bfc7-4ed9-a924-0f9d859b369e
function A_Star(Actions, Start, goal, h)
	explored = []
	explore = Queue{Position}()
	enqueue!(explore, Start)
	while true 
